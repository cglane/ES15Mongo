...
var examples = require('./examples.js');
      ...
      //   })
        ...
        //     request(url)
        //       .post('/api/include_translation/'+key)
        ...
        describe('Data Upload',function(){
          it('should create new terms from json',function(done){
            request(url)
              ...
              .send({url:'./test/exampleJSON.json'})
              .end(function(err,res){
                if(err)throw err;
                res.status.should.be.equal(200);
              })
          })
          it('should create new translations for spanish data',function(done){
            request(url)
              .post('/api/upload_create_file/common/12345/sp-am')
              .send({url:'./test/exampleJSON.json'})
              .end(function(err,res){
                if(err)throw err;
                res.status.should.be.equal(200);
